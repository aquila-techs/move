        ...
        <div class="col-lg-12">
            <div class="card" style="min-height: 500px;">
                <div class="card-body">
                             ...
                             @if( isset( $blog ) )
                                   <form action="{{ url('admin/blogs/'.$blog->id)  }}" id="blogForm" method="post" class="parsley-examples">
                            @else
                                   <form action="{{ url('admin/blogs')  }}" method="post" id="blogForm" class="parsley-examples">
                            @endif
                                @csrf
                                @if( isset($blog) )
                                @method('PUT')
                                    ...
                                    <div class="col-9">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select type="text" id="user_id" name="user_id"  parsley-trigger="change" required
                                                        class="form-control @if($errors->has('user_id')) is-invalid @endif">
                                                    @if(isset($blog))
                                                        <option value="{{ old('user_id',$blog->author->id)  }}">{{ old('user_id',$blog->author->name)  }}</option>
                                                    @endif
                                        ...
                                        <div class="row mt-5">
                                            <div class="form-group btns-div col-12">
                                                <a href="{{ url('admin/blogs') }}" class="btn btn-md btn-light mr-5"> Cancel </a>
                                                <button type="button" id="btn" class="btn btn-md btn-primary "> Save </button>
                                            </div>
                                        </div>
                                     </form>
                                    </div>
