...
<head>
    ...
    <title>Move in and out - Company Dashboard </title>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        ...
        @include('companies.layouts.shared.head')
...
@endif
    ...
    <div id="wrapper">
        ...
        @include('companies.layouts.shared.header')
        @include('companies.layouts.shared.sidebar')
        ...
        <div class="content-page">
            ...
            @include('companies.layouts.shared.footer')
        </div>
    </div>

    @include('companies.layouts.shared.footer-script')
