			...
			<div id="header-wrap">
					...
					<div class="container clearfix">
						...
						<div class="row justify-content-between">
							<div class="col-12 col-md-auto">
								<marquee class="mt-3">
									Our services are open in this crucial time, but delivery time can extend due to COVID-19. Stay Safe. 
								</marquee>
							</div>
				...
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="{{ url('/') }}" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="{{ asset('front/images/logo.png') }}" alt="Canvas Logo"></a>
							<a href="{{ url('/') }}" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="{{ asset('front/images/logo@2x.png') }}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						...
						<div class="header-misc">
							...
							============================================= -->
							<div  class="menu-item">
								<a href="{{ route('login') }}" class="menu-link btn btn-primary text-white" style="margin: 0; padding: 10px;"> Login </a>
							</div>
							...
							<ul class="menu-container">
								<li class="menu-item">
									...
									<ul class="sub-menu-container">
										<li class="menu-item">
											<a class="menu-link" href="{{ url('blog_I') }}"><div>Blog I</div></a>
										</li>
										<li class="menu-item">
											<a class="menu-link" href="{{ url('blog_II') }}"><div>Blog II</div></a>
										</li>
										<li class="menu-item">
								...
								<li class="menu-item">
									<a href="{{ url('about_us') }}" class="menu-link"> About Us </a>
								</li>
								<li class="menu-item">
									<a href="{{ url('contact_us') }}" class="menu-link"> Contact Us </a>
								</li>
								<li class="menu-item">
									<a href="{{ url('faqs') }}" class="menu-link"> FAQs </a>
								</li>
